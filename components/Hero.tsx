      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 text-left">
            ...
            I'm Povel, a software developer with a background in programming and project management at companies like Spotify. I've always been drawn to creative work and building things, and over the last couple of years I've been dedicating more time to exactly that — composing, game development, and various side projects. Below are a few of the things I've been working on lately.
            </p>
