...
const Projects: React.FC = () => {
  ...
  const projects: ProjectType[] = [
    ...
    {
      id: 9,
      title: "GamingNovember",
      description: "Website for our yearly game month event featuring live leaderboards and game submissions.",
      longDescription: "GamingNovember is an annual game development event where participants create and submit games throughout November. The website features real-time leaderboards that track scores and rankings during the event. Players can submit their games and compete for top positions on the leaderboard, creating an engaging community-driven competition. The platform showcases the best games from each year's event and provides a central hub for the gaming community.",
      imageUrl: "/projects/gaming-november.svg",
      cardImageUrl: "/projects/gaming-november.svg",
      category: "other",
      tags: ["Next.js", "TypeScript", "Tailwind CSS", "Vercel"],
      githubUrl: "https://github.com/parvelmarv/gaming_november",
      websiteUrl: "https://www.gamingnovember.com"
    }
  ];
      ...
      <section id="projects" className="py-20 relative">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className={`relative bg-white rounded-b-lg ${!isMenuOpen ? 'lg:rounded-tr-lg' : ''} border border-gray-200 p-8 shadow-[0_8px_16px_-4px_rgba(0,0,0,0.1)]`}>
            {/* Unity Game Component - Only show on Games tab */}
            {activeTab === 'games' && (
              <div className="mb-8">
                <UnityGame 
                  gameName="RolloRocket"
                  r2GameName="RolloRocket"
                  height="600px"
                />
              </div>
            )}
